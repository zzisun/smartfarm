    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('option', models.TextField(blank=True, default='', null=True, verbose_name='Option')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('amount', models.PositiveIntegerField(default=0, verbose_name='product_amount')),
                ('status', models.CharField(choices=[('Proc', 'Processing'), ('Ship', 'Shipped'), ('On', 'On the way'), ('Deli', 'Delivered')], default='Proc', max_length=4, verbose_name='status')),
                ('option', models.TextField(blank=True, default='', null=True, verbose_name='Option')),
