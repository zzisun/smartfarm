    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_user', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
        ),
        migrations.CreateModel(
            name='Farm_Info',
            fields=[
                ...
                ('farm_name', models.CharField(default='farm2021-06-07-03:35:38-PM', max_length=30)),
                ...
                ('device_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='farms', to='device_management.device_info')),
            ],
        ),
        migrations.CreateModel(
            name='mock_params',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('farm_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='plants', to='device_management.farm_info')),
            ],
        ),
        migrations.CreateModel(
            name='Growth_Params',
            fields=[
                ...
                ('device_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='params', to='device_management.device_info')),
